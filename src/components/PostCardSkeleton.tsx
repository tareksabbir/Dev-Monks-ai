...
export function PostCardSkeleton() {
  return (
    <div className="bg-[#fef9e8] border border-[#d8c8a8] flex flex-col justify-between h-45">
...
export function FeaturedPostSkeleton() {
  return (
    <div
      ...
      style={{
        backgroundImage:
          "linear-gradient(to right, rgba(180,160,120,0.35) 1px, transparent 1px), linear-gradient(to bottom, rgba(180,160,120,0.35) 1px, transparent 1px)",
