  ...
  return (
    ...
    >
      <div className="p-6 pb-8">
        ...
        {post.excerpt && (
          <p className="text-[13px] text-[#6a6050] leading-relaxed line-clamp-3">
            {post.excerpt}
          </p>
        )}
      </div>
      ...
      <div className="flex items-stretch border-t border-[#d8c8a8] h-10 bg-[#f9f3dd]/40">
        <div className="w-25 border-r border-[#d8c8a8] flex items-center px-4 text-[11px] font-medium text-[#1a1a1a]/80">
          {post.date}
        </div>
