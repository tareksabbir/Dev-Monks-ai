export function PixelCat() {
  return (
    <svg width="80" height="40" viewBox="0 0 80 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M20 20 H25 V15 H30 V20 H45 V15 H50 V20 H55 V25 H60 V35 H20 V25 Z" fill="transparent" stroke="#1a1a1a" strokeWidth="2" strokeLinejoin="miter"/>
      ...
      <path d="M10 25 H20 V35 H15 V30 H10 V25 Z" fill="transparent" stroke="#1a1a1a" strokeWidth="2" strokeLinejoin="miter"/>
      <path d="M60 25 H70 V35 H65 V30 H60 V25 Z" fill="transparent" stroke="#1a1a1a" strokeWidth="2" strokeLinejoin="miter"/>
    </svg>
  );
}
