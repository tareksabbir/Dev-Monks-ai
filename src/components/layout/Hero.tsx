...
export function Hero() {
  return (
    <section className="w-full relative border-b border-hero-border flex flex-col items-center justify-center pt-24 pb-16 overflow-hidden">
      ...
      <div className="relative z-10 px-6 text-center max-w-5xl mx-auto">
        <motion.h1
          className="text-[2.75rem] md:text-6xl font-normal text-foreground tracking-tight"
